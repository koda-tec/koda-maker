...
export function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 z-50 w-full h-20 bg-white border-t border-gray-100 px-6 pb-4 md:top-0 md:left-0 md:w-20 md:h-screen md:border-t-0 md:border-r md:flex-col md:py-8 md:px-0">
