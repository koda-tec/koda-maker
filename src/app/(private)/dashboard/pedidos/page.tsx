              ...
              <div className="p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-gray-50 p-6 rounded-[35px] border border-gray-100 italic font-bold text-gray-600 relative">
                        <p className="text-[10px] font-black uppercase text-gray-400 mb-2 not-italic tracking-widest underline decoration-[#f13d4b] decoration-2"><Paintbrush size={14} className="inline mr-2" />Hoja de Taller</p>
