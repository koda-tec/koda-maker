        ...
        <div className="flex flex-col gap-3 w-full md:w-auto">
            ...
            <form className="relative group">
                ...
                <input 
                    ...
                    className="w-full md:w-64 pl-12 pr-4 py-3 bg-white border border-zinc-100 rounded-2xl outline-none focus:ring-2 focus:ring-accent shadow-sm text-sm font-bold"
                />
            </form>
            {/* Pestañas de Filtro */}
        ...
        <section className="bg-white p-6 md:p-10 rounded-[40px] shadow-sm border border-zinc-100 mx-2 md:mx-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1 text-left">
                    ...
                    <input name="customerName" placeholder="Juan Pérez" className="w-full p-4 bg-zinc-50 border-none rounded-2xl outline-none focus:ring-2 focus:ring-accent text-sm font-bold" required />
                </div>
                <div className="space-y-1 text-left">
                    <label className="text-[9px] font-black uppercase text-zinc-400 ml-2">WhatsApp</label>
                    <input name="customerPhone" placeholder="11 2233 4455" className="w-full p-4 bg-zinc-50 border-none rounded-2xl outline-none focus:ring-2 focus:ring-accent text-sm font-bold" />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-2 space-y-1 text-left">
                    ...
                    <select name="templateId" className="w-full p-4 bg-zinc-50 rounded-2xl text-sm font-black border-none appearance-none cursor-pointer" required>
                ...
                <div className="space-y-1 text-left">
                    ...
                    <input name="quantity" type="number" defaultValue="1" min="1" className="w-full p-4 bg-zinc-50 rounded-2xl text-sm font-black text-center border-none" required />
                </div>
            </div>

            <div className="space-y-1 text-left">
                <label className="text-[9px] font-black uppercase text-zinc-400 ml-2">Detalles del Diseño / Grabado</label>
                <textarea name="designDetails" placeholder="Ej: Logo empresa en frente, nombre atrás..." className="w-full p-4 bg-zinc-50 border-none rounded-2xl outline-none text-sm font-medium h-24 resize-none" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                ...
                <div className="space-y-1">
                    ...
                    <input name="deliveryDate" type="date" className="w-full p-4 bg-gray-50 rounded-2xl text-sm font-black border-none h-14" />
                </div>
            </div>
      ...
      <div className="space-y-10">
            ...
            <div key={order.id} className={`bg-white rounded-[45px] overflow-hidden border-2 transition-all ${isQuote ? 'border-dashed border-zinc-200 opacity-90' : isDelivered ? 'grayscale-[0.4] opacity-90 border-transparent shadow-md' : 'border-transparent shadow-2xl shadow-zinc-100'}`}>
              ...
              <div className="p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
                ...
                <div className="flex flex-col justify-between space-y-10">
                    ...
                    <div className="relative">
                        {order.images && order.images.length > 0 ? (
                            <div className="space-y-3">
                                ...
                                <p className="text-[9px] font-black text-center text-zinc-400 uppercase tracking-widest italic">Desliza para ver fotos ({order.images.length})</p>
                            </div>
                        ) : (
                    ...
                    {/* SECCIÓN FINANCIERA CORREGIDA PARA RESPONSIVE */}
                    <div className="space-y-6">
                        ...
                        {/* ESTADO FINANCIERO / BARRA DE COBRO */}
                        <div className="space-y-4 bg-zinc-50/50 p-4 rounded-[30px] border border-zinc-50">
                            <div className="flex justify-between items-end px-1 gap-2">
                                <span className="text-[10px] font-black uppercase text-zinc-400">Progreso financiero</span>
        ...
        {orders.length === 0 && (
          <div className="text-center py-24 bg-zinc-50 rounded-[60px] border-2 border-dashed border-zinc-200 mx-4 md:mx-0">
             <ShoppingCart className="text-zinc-200 mx-auto mb-4" size={64} />
             <p className="text-zinc-400 font-bold uppercase tracking-widest text-xs italic">Aún no hay operaciones en esta sección</p>
          </div>
        )}
      </div>
    </div>
