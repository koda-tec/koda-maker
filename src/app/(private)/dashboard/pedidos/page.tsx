...
export default async function OrdersPage() {
  ...
  // 1. Cargamos pedidos con sus items (para ver el nombre del producto) y pagos
  ...
  // 2. Cargamos plantillas para el selector del formulario
    ...
    <div className="max-w-5xl mx-auto space-y-12 pb-32 pt-6 px-2 md:px-4">
      ...
      <section className="bg-white p-6 md:p-10 rounded-[40px] shadow-sm border border-gray-100 mx-2 md:mx-0">
        ...
        <form action={createOrder} className="space-y-6">
          ...
          <textarea name="designDetails" placeholder="Instrucciones de grabado (Ej: Logo empresa en frente, nombre atrás)..." className="w-full p-4 bg-gray-50 rounded-2xl text-sm font-medium h-24 border-none resize-none" />
            ...
            <div key={order.id} className={`bg-white rounded-[45px] overflow-hidden border-2 transition-all ${isQuote ? 'border-dashed border-gray-200' : 'border-transparent shadow-2xl shadow-gray-100'}`}>
              ...
              <div className="p-6 md:p-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    {/* COLUMNA DERECHA: IMAGEN Y FINANZAS */}
                    <div className="flex flex-col justify-between space-y-8">
                        ...
                        <div className="relative group">
                            {order.fileUrl ? (
                                <div className="space-y-3">
                                    <div className="rounded-[40px] overflow-hidden border-8 border-white shadow-2xl h-64 relative">
                                    ...
                                    <p className="text-[9px] font-black text-center text-gray-400 uppercase tracking-widest italic">Archivo de referencia</p>
                                </div>
                            ) : (
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center px-1">
                                    <span className="text-[10px] font-black uppercase text-gray-400">Progreso cobro</span>
                        ...
                        <div className="pt-4 flex flex-col gap-3">
                            ...
                            <a 
                              ...
                              target="_blank"
                              className="text-center py-2 text-[10px] font-black text-gray-400 uppercase hover:text-black transition-all flex items-center justify-center gap-2"
                            >
