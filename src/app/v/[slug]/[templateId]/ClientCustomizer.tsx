...
import { 
  ...
  Calendar, 
  Info, 
  Clock, // Ícono agregado para corregir el error
  CheckCircle2 
} from "lucide-react"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
            ...
            <div className="space-y-6">
                <div className="w-full aspect-square rounded-[50px] overflow-hidden bg-zinc-100 shadow-sm border border-zinc-100">
                    {activeImage ? (
                        <img src={activeImage} className="w-full h-full object-cover transition-all duration-500 animate-in fade-in" alt={template.name} />
                    ) : (
                ...
                {template.images && template.images.length > 1 && (
                    <div className="space-y-2">
                        <p className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] ml-2 italic">Explorar variantes</p>
                ...
                <div className="px-4 space-y-4 pt-4">
                    ...
                    <p className="text-zinc-500 font-medium leading-relaxed italic border-l-4 border-zinc-100 pl-4">
                ...
                <form action={handleSubmit} encType="multipart/form-data" className="space-y-10 relative z-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            {/* Input de cantidad (Numérico directo) */}
                            <div className="space-y-2">
                            ...
                            {/* CAJA INFORMATIVA DE FECHA (Coordinación) */}
                    ...
                    <div className="pt-8 border-t border-zinc-100 space-y-6">
                        ...
                        <button 
                            type="submit" 
                            disabled={isPending} 
                            className="w-full p-6 bg-black text-white rounded-[30px] font-black uppercase text-xs tracking-[0.2em] shadow-2xl flex items-center justify-center gap-3 hover:bg-accent transition-all active:scale-95 disabled:opacity-50"
                        >
                            {isPending ? <Loader2 className="animate-spin" size={20} /> : <Send size={20} />}
                            {isPending ? "PROCESANDO SOLICITUD..." : "Enviar Solicitud de Pedido"}
                        </button>
                    </div>
                </form>
